...
# СПм-24-4, Свистельник Артем Олександрович
...
![Скріншот моделі в процесі симуляції](result.jpg)

Фінальний код моделі та її інтерфейс доступні за [посиланням](./Traffic%Grid%_modified.nlogox).
